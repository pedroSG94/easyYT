 ...
 */
public class EasyYTViewFFMPEG extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback{

  private final String TAG = EasyYTViewFFMPEG.class.toString();
  ...
  public EasyYTViewFFMPEG(Context context) {
    super(context);
  }

  public EasyYTViewFFMPEG(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public EasyYTViewFFMPEG(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  public void initRecordVideo(){
    holder = getHolder();
    holder.addCallback(EasyYTViewFFMPEG.this);
    holder.setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
    camera.setPreviewCallback(EasyYTViewFFMPEG.this);
